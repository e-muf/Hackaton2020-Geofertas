...
CREATE TABLE TIPO_TARJETA_CREDITO(
    TIPO_TARJETA_ID    NUMBER(10, 0)    NOT NULL,
    DESCRIPCION        VARCHAR2(40)    NOT NULL,
    NOMBRE             VARCHAR2(40)    NOT NULL,
...
CREATE TABLE BENEFICIO(
    BENEFICIO_ID    NUMBER(10, 0)    NOT NULL,
...
CREATE TABLE ASOCIADOS(
    ...
    CONSTRAINT RefBENEFICIO18 FOREIGN KEY (BENEFICIO_ID)
...
CREATE TABLE OFERTA_PERSONAL(
    OFERTA_PERSONAL_ID    NUMBER(10, 0)     NOT NULL,
    OFERTA_ID             NUMBER(10, 0)    NOT NULL,
    CUENTA_ID             NUMBER(10, 0)     NOT NULL,
